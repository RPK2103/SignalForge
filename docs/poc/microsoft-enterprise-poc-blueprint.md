...
| DevOps | GitHub Actions CI | GitHub Actions; Azure DevOps as optional **source** connector later | Pipeline to Azure env | POC CONFIGURATION |
| AI | Deterministic fallback + provider abstraction; Azure client paths exist | Azure OpenAI when approved | Keys, grounding policy, disable-in-CI | POC CONFIGURATION |
